...
BASE_DIR=/Volumes/ExtSD/Projects/Xcode_Projects/${APP_NAME}/Source_code/Github/${APP_NAME}
...
AppCastDir=/Volumes/ExtSD/Projects/Xcode_Projects/${APP_NAME}/Source_code/Github/appcast
